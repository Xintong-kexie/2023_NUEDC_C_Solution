...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   RAMLS2      : origin = 0x009000, length = 0x014000
   RAMLS3      : origin = 0x01D000, length = 0x000800
   RAMLS4      : origin = 0x01D800, length = 0x000800
   RAMLS5      : origin = 0x01E000, length = 0x000800
   RAMLS6      : origin = 0x01E800, length = 0x001000
   RAMLS7      : origin = 0x01F800, length = 0x000800

   RAMGS0      : origin = 0x020000, length = 0x001000
   RAMGS1      : origin = 0x021000, length = 0x001000
   RAMGS2      : origin = 0x022000, length = 0x001000
   RAMGS3      : origin = 0x023000, length = 0x001FF8
